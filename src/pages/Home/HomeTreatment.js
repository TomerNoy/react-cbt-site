  ...
  return (
    <Element name="treatment-section" className="section">
      <div className="home-treatments page-text">
        ...
        <p>
          לפעמים יש תקופות שקשה לנו. רגעים שבהם משהו מרגיש תקוע, מעורפל או פשוט כואב מבפנים. התחושות האלו יכולות ללוות אותנו בשקט או להציף בעוצמה. דווקא ברגעים כאלה חשוב לזכור שיש דרך לצאת מהסבך, יחד, צעד אחר צעד.
        </p>
        <p>
        ...
        <p>
          ...
          קריטי בגיבוש הזהות האישית. בנוסף, מתבגרים מתמודדים עם מצבי לחץ,
